...
runOfficeHousekeepingTests(runner)
runAgentTokenInfoTests(runner)
runOfficeRoomLayoutTests(runner)
runOfficeFloorPlanTests(runner)
runOfficeColorProbeTests(runner)
runOfficeViewMetricsTests(runner)
runOfficeFloorCalibrationTests(runner)
runOfficeZoneHitTests(runner)
...
runOfficeFeatureTilePolicyTests(runner)
