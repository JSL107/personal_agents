...
//
// 10 → 20 (2026-09-18). 경고 기준과 맞물려야 해서 올렸다 — 발송 formatter 가 「직전 대비 ±5%p」
// 를 경고선으로 쓰는데, 표본 20건에서 1건이 정확히 5%p 다. 그보다 적으면 **한 건만 뒤집혀도
// 경고가 울려** 기준이 무의미해진다(10건이면 1건 = 10%p). 실측(2026-09-18)으로는 READABILITY
// 16건이 이 상향으로 비율 미표시로 바뀌고, RELIABILITY 21건부터 표시된다.
export const ADOPTION_MIN_SAMPLE = 20;
