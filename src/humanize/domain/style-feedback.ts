...
// 현재 윤문 경로가 실제로 판정하는 축만 되먹인다. 과거 원장에는 평균·최장·어절처럼
// 지금은 관측값으로만 남긴 문장 길이 갭도 있으므로, "내리지 않은 축이면 허용"하는 방식으로는
// 옛 숫자가 다시 모델 프롬프트에 섞인다.
const JUDGED_GAP_LABELS = new Set([
  '종결체교대',
  '금지접속사',
  '줄표',
  '인용체',
