...
- risks 는 **회고 대상 기간(입력 첫 줄의 \`[기간]\`)에 관찰된 문제·위험** 만. 실패·차단·미검증 구간·
  되돌리기 어려운 변경 등. 하루 회고면 그날, 주간 요약이면 그 주 전체가 대상이다 — 기간이 여러 날이면
  중간에 나온 위험도 빠뜨리지 않는다. 근거가 입력에 있어야 한다
  (예: "머지된 PR 3건 중 1건이 실 환경 미검증", "PM 이 식별한 차단 요소가 그대로 남음").
