...
- 봇 자체에 대한 안부성 메타 질문 ("오늘 컨디션 어때?", "이대리 봇 문제 있어?") — 단, 진행 상황·지연·병목을 묻는 질문 ("지금 뭐해?", "잘 되고 있어?", "왜 늦어져?") 은 DELAY_REPORT 로 분류한다
...
봇이 직전 [assistant] turn 에서 마감 등록에 필요한 **날짜를 되물었고** (예: "… 언제까지인가요?"),
사용자가 이번 turn 에 날짜만 답하면 (예: "9월 30일", "내일", "다음주 월요일") 그것은 **SCHEDULE**
의 후속 입력이다. 무엇을 등록할지 되물은 경우(예: "무엇을 등록할까요?") 의 답도 같다.
**UNKNOWN 으로 흘리지 말 것.**
