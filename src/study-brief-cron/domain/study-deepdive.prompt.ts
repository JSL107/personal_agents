...
export const buildStudyDeepdivePrompt = ({
  ...
  [
    ...
    '아래 여섯 갈래는 다뤄야 할 내용이지 소제목 목록이 아니다. 그대로 옮기면 글마다 뼈대가 같아져 틀에 맞춰 찍어낸 티가 난다. 틀은 주제에 맞게 매번 새로 고른다 — 겪은 문제를 하나씩 파헤치는 틀, 단계마다 무엇이 나아졌는지 보여주는 틀, 선택지를 나란히 놓고 견주는 틀처럼. 여섯 갈래는 그 틀 안에 녹여 넣어라.',
