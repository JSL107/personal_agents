...
export class EnvironmentVariables {
  ...
  // 모의투자 일일 평가. 명시적으로 'true' 일 때만 실행하며 기본값은 비활성이다.
  @IsOptional()
  @IsIn(['true', 'false'])
  ...
  // 포트폴리오 사이트 발행 슬롯. 워밍업과 마찬가지로 단독 그룹이다.
  @IsOptional()
  @IsString()
  AUTOPILOT_PORTFOLIO_PUBLISH_SCHEDULE?: string;

  @IsOptional()
  @IsString()
  AUTOPILOT_PORTFOLIO_PUBLISH_TIMEZONE?: string;
  ...
  @IsOptional()
  @IsString()
  AUTOPILOT_PAPER_TRADING_SCHEDULE?: string;
