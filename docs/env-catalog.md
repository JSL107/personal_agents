...
SoT: `src/config/app.config.ts` 의 `EnvironmentVariables` (class-validator). 총 66개.
...
| 키 | 필수 | 설명 |
|---|---|---|
| `MORNING_BRIEFING_OWNER_SLACK_USER_ID` | ❌ | PRO-1 Morning Briefing CRON 설정. |
...
| `AUTOPILOT_OWNER_SLACK_USER_ID` | ❌ | Autopilot SP1 — 선언적 워크데이 플레이북 엔진 (2026-06-17, Daily Eval 실이관). |
| `AUTOPILOT_TARGET` | ❌ | — |
