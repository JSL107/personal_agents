...
- Node 22.12+, NestJS 10, Prisma 6 (TypeORM 절대 X), Slack Bolt 4, BullMQ. (`package.json` `engines` 로 명시 — 20 은 지원 종료. 하한이 22.0 이 아니라 22.12 인 것은 puppeteer 25 가 그것을 요구해서다)
